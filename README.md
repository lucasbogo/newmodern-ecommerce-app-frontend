...
<br>
<br>
O repositório referente ao back-end/API da aplicação newmodern econtra-se neste repositório: [NewModern Ecommerce API - BACK-END](https://github.com/lucasbogo/newmodern-ecommerce-frontend)
